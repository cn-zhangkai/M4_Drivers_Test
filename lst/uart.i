...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    uint32_t u32ClkTbl[4] = {(24000000UL), 0ul, (32768UL), (12000000UL)};
    uint32_t u32Baud_Div = 0ul;
    uint32_t u32UartPort;

    if(uart==(UART_T*)((UART_T *) (0x40880000UL)))
    {
        u32UartPort = 16;
    }
    else
    ...
    if((u32UartPort >= 1) && (u32UartPort <= 7))
    {
        u32UartClkSrcSel = ((((CLK_T *) (0x40460200UL))->CLKSEL2 >> (16 + u32UartPort*2)) & 0x3ul);

        if((u32UartPort >= 1) && (u32UartPort <= 3))
    {
            u32UartClkDivNum = ((((CLK_T *) (0x40460200UL))->CLKDIV1 >> ((u32UartPort+4)*4)) & 0xful);
    }
        else
    {
            u32UartClkDivNum = ((((CLK_T *) (0x40460200UL))->CLKDIV2 >> ((u32UartPort-4)*4)) & 0xful);
    }
    }
    else if((u32UartPort >= 8) && (u32UartPort <= 16))
    {
        u32UartClkSrcSel = ((((CLK_T *) (0x40460200UL))->CLKSEL3 >> ((u32UartPort-8)*2)) & 0x3ul);

        if((u32UartPort >= 8) && (u32UartPort <= 11))
        {
            u32UartClkDivNum = ((((CLK_T *) (0x40460200UL))->CLKDIV2 >> ((u32UartPort-4)*4)) & 0xful);
        }
        else
    {
            u32UartClkDivNum = ((((CLK_T *) (0x40460200UL))->CLKDIV3 >> ((u32UartPort-12)*4)) & 0xful);
    }
    }
    ...
    {
        u32ClkTbl[u32UartClkSrcSel] = CLK_GetSYSCLK1Freq();
    }
...
{
    uint32_t u32UartClkSrcSel=0ul, u32UartClkDivNum=0ul;
    uint32_t u32ClkTbl[4ul] = {(24000000UL), 0ul, (32768UL), (12000000UL)};
    uint32_t u32Baud_Div = 0ul;
    uint32_t u32UartPort;
