...
void CLK_DisableCKO(void)
{
    ...
    CLK_DisableModuleClock(((1UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(13UL<<0)));
}
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (0x40460200UL))->CLKOCTL = (0x1ul << (4)) | (u32ClkDiv) | (u32ClkDivBy1En << (5));

     
    CLK_EnableModuleClock(((1UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(13UL<<0)));

     
    CLK_SetModuleClock(((1UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(13UL<<0)), u32ClkSrc, 0UL);
}
...
void CLK_PowerDown(void)
{
    ...
    ((SYS_T *) (0x40460000UL))->PMUCR |= ((0x1ul << (24)));
...
uint32_t CLK_GetHXTFreq(void)
{
    ...
    if ((((CLK_T *) (0x40460200UL))->PWRCTL & (0x1ul << (0))) == (0x1ul << (0)))
    {
        u32Freq = (24000000UL);
    }
    else
...
uint32_t CLK_GetLXTFreq(void)
{
    ...
    if ((((CLK_T *) (0x40460200UL))->PWRCTL & (0x1ul << (1))) == (0x1ul << (1)))
    {
        u32Freq = (32768UL);
    }
    else
...
uint32_t CLK_GetSYSCLK0Freq(void)
{
    ...
    if ((((CLK_T *) (0x40460200UL))->CLKSEL0 & (0x1ul << (2))) == (0x0UL<<(2)))
    {
        u32Freq = CLK_GetPLLClockFreq((0x4UL));
    }
    else
    {
        u32Freq = 180000000UL;
...
uint32_t CLK_GetSYSCLK1Freq(void)
{
    ...
    if ((((CLK_T *) (0x40460200UL))->CLKSEL0 & (0x1ul << (4))) == (0x0UL<<(4)))
    {
        u32Freq = (24000000UL);
    }
    else 
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    if (u32Hclk > 180000000UL)
    {
        u32Hclk = 180000000UL;
    }

#line 301 "..\\..\\Library\\StdDriver\\src\\clk.c"
...
{
#line 348 "..\\..\\Library\\StdDriver\\src\\clk.c"
}
...
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    ...
    if (u32ModuleIdx == ((2UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(31UL<<0)))
    {
        ((CLK_T *) (0x40460200UL))->CLKDIV4 = ((CLK_T *) (0x40460200UL))->CLKDIV4 & ~((0xfful << (24))) | u32ClkDiv;
        ((CLK_T *) (0x40460200UL))->CLKSEL4 = ((CLK_T *) (0x40460200UL))->CLKSEL4 & ~((0x1ul << (30))) | u32ClkSrc;
        ((CLK_T *) (0x40460200UL))->APBCLK0 = ((CLK_T *) (0x40460200UL))->APBCLK0 & ~((0x1ul << (31))) | (0x1ul << (31));
    }
    else if (u32ModuleIdx == ((4UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(24UL<<0)))
    {
        ((CLK_T *) (0x40460200UL))->CLKDIV4 = ((CLK_T *) (0x40460200UL))->CLKDIV4 & ~((0x1fffful << (4))) | u32ClkDiv;
        ((CLK_T *) (0x40460200UL))->APBCLK2 = ((CLK_T *) (0x40460200UL))->APBCLK2 & ~((0x1ul << (24))) | (0x1ul << (24));
    }
    else
    {
        if ((((u32ModuleIdx) >>10) & 0xfUL) != 0x0UL)
        {
             
            u32div = (uint32_t)&((CLK_T *) (0x40460200UL))->CLKDIV0 + (((((u32ModuleIdx) >>14) & 0x7UL)) * 4U);
             
            (*((vu32 *) (u32div))) = ((*((vu32 *) (u32div))) & (~((((u32ModuleIdx) >>10) & 0xfUL) << (((u32ModuleIdx) >>5 ) & 0x1fUL)))) | u32ClkDiv;
        }

        if ((((u32ModuleIdx) >>22) & 0xfUL) != 0x0UL)
        {
             
            u32sel = (uint32_t)&((CLK_T *) (0x40460200UL))->CLKSEL0 + (((((u32ModuleIdx) >>26) & 0x7UL)) * 4U);
             
            (*((vu32 *) (u32sel))) = ((*((vu32 *) (u32sel))) & (~((((u32ModuleIdx) >>22) & 0xfUL) << (((u32ModuleIdx) >>17) & 0x1fUL)))) | u32ClkSrc;
        }
    }
}
...
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
    ((CLK_T *) (0x40460200UL))->CLKSEL0 = (((CLK_T *) (0x40460200UL))->CLKSEL0 & ~(0x7ul << (8))) | u32ClkSrc;
}
...
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) (0x40460200UL))->PWRCTL |= u32ClkMask;
}
...
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
    ...
    u32tmpAddr = (uint32_t)&((CLK_T *) (0x40460200UL))->SYSCLK0;
    u32tmpAddr += (((((u32ModuleIdx) >>29) & 0x7UL) * 4UL));
...
{
    return (((CLK_T *) (0x40460200UL))->PLL[u32PllIdx].CTL0 & (0x3ul << (18))) >> (18);
}
...
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
    ...
    while ((((CLK_T *) (0x40460200UL))->STATUS & u32ClkMask) != u32ClkMask)
    {
        if (i32TimeOutCnt-- <= 0)
        {
            u32Ret = 0U;
...
uint32_t CLK_GetCAPLLClockFreq(void)
{
    ...
    u32N = (((CLK_T *) (0x40460200UL))->PLL0CTL0 & (0xfful << (0)));
    u32M = (((CLK_T *) (0x40460200UL))->PLL0CTL0 & (0xful << (8))) >> ((8));
    u32P = (((CLK_T *) (0x40460200UL))->PLL0CTL0 & (0x3ul << (12))) >> ((12));

     
    u32RefClk = (24000000UL) / 100;
...
uint32_t CLK_GetPLLClockFreq(uint32_t u32PllIdx)
{
    ...
    u32CTLVal0 = *(volatile uint32_t *)((0x40460200UL) + 0x60 + (0x10 * (u32PllIdx)));
    u32CTLVal1 = *(volatile uint32_t *)((0x40460200UL) + 0x64 + (0x10 * (u32PllIdx)));

    if (u32Mode == 0)
    {
        u32N = (u32CTLVal0 & (0x7fful << (0)));
        u32M = (u32CTLVal0 & (0x3ful << (12))) >> ((12));
        u32P = (u32CTLVal1 & (0x7ul << (4))) >> ((4));
    ...
    else if (u32Mode == 1)
    {
        ...
        u32M = (u32CTLVal0 & (0x3ful << (12))) >> ((12));
        u32P = (u32CTLVal1 & (0x7ul << (4))) >> ((4));
        u32X = (u32CTLVal1 & (0xfffffful << (8))) >> ((8));

         
        u32X = (((u32X * 1000) + 500) >> 24);
        u32PllClk = ((24000000UL) * ((u32N * 1000) + u32X)) / 1000 / u32P / u32M;
    }
    else
    {
        u32N = (u32CTLVal0 & (0x7fful << (0)));
...
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    ...
    if ((((u32ModuleIdx) >>22) & 0xfUL) != 0x0UL)
    {
        ...
        u32sel = (uint32_t)&((CLK_T *) (0x40460200UL))->CLKSEL0 + (u32SelTbl[(((u32ModuleIdx) >>26) & 0x7UL)]);
         
        return (((*((vu32 *) (u32sel))) & ((((u32ModuleIdx) >>22) & 0xfUL) << (((u32ModuleIdx) >>17) & 0x1fUL))) >> (((u32ModuleIdx) >>17) & 0x1fUL));
    }
    else
        return 0;
}
...
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    ...
    if ((((u32ModuleIdx) >>10) & 0xfUL) != 0x0UL)
    {
        if (u32ModuleIdx == ((2UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(31UL<<0)))
        {
            u32div = (((CLK_T *) (0x40460200UL))->CLKDIV4 & (0xfful << (24))) >> (24);
            return u32div;
        }
        else if (u32ModuleIdx == ((4UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(24UL<<0)))
        {
            u32div = (((CLK_T *) (0x40460200UL))->CLKDIV4 & (0x1fffful << (4))) >> (4);
            return u32div;
        }
        else
        {
             
            u32div = (uint32_t)&((CLK_T *) (0x40460200UL))->CLKDIV0 + (u32DivTbl[(((u32ModuleIdx) >>14) & 0x7UL)]);
             
            return (((*((vu32 *) (u32div))) & ((((u32ModuleIdx) >>10) & 0xfUL) << (((u32ModuleIdx) >>5 ) & 0x1fUL))) >> (((u32ModuleIdx) >>5 ) & 0x1fUL));
        }
    }
    else
        return 0;
