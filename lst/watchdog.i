...
{
    if(((((WWDT_T *) (0x40980100UL))->STATUS & (0x1ul << (0)))? 1 : 0) == 1)
    {
         
        (((WWDT_T *) (0x40980100UL))->STATUS = (0x1ul << (0)));
...
void WWDT_init(void)
{
	...
	CLK_SetModuleClock(((3UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(18UL<<0)), (0x3UL<<(30)), 0);
...
void KickDog(void)
{
    (((WWDT_T *) (0x40980100UL))->RLDCNT = (0x00005AA5));
}
