...
#line 9 "main.c"
#line 1 "E:\\Keil_v5\\ARM\\ARM_Compiler_5.06u7\\Bin\\..\\include\\time.h"
...
#line 41 "E:\\Keil_v5\\ARM\\ARM_Compiler_5.06u7\\Bin\\..\\include\\time.h"
    ...
    typedef unsigned int size_t;    
#line 57 "E:\\Keil_v5\\ARM\\ARM_Compiler_5.06u7\\Bin\\..\\include\\time.h"
...
#line 73 "E:\\Keil_v5\\ARM\\ARM_Compiler_5.06u7\\Bin\\..\\include\\time.h"
...
#line 280 "E:\\Keil_v5\\ARM\\ARM_Compiler_5.06u7\\Bin\\..\\include\\time.h"
...
#line 27 ".\\Devices\\watchdog.h"
#line 28 ".\\Devices\\watchdog.h"
...
void UART16_Init()
{
    ...
    CLK_EnableModuleClock(((2UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(28UL<<0)));

     
    CLK_SetModuleClock(((2UL<<29)|(0x0UL<<26)|(0x0UL<<22)|(0x0UL<<17)|(0x0UL<<14)|(0x0UL<<10)|(0x0UL<<5)|(28UL<<0)), (0x0UL<<(16)), (((1) - 1UL) << (16)));
	
	SystemCoreClockUpdate();

     
    ((SYS_T *) (0x40460000UL))->GPK_MFPL &= ~((0xful << (8)) | (0xful << (12)));
    ((SYS_T *) (0x40460000UL))->GPK_MFPL |= ((0x02UL<<(8)) | (0x02UL<<(12)));
	
	 
    SYS_LockReg();
	
	 
    UART_Open(((UART_T *) (0x40880000UL)), 115200);
}
...
int32_t main(void)
{
    ...
    printf("[WWDT_CTL: 0x%08X]\n\n", ((WWDT_T *) (0x40980100UL))->CTL);
	
	finish_t = clock();
    total_t = (double)(finish_t - start_t) / 100;
