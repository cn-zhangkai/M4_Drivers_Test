...
{
    while(((UART_T *) (0x40880000UL))->FIFOSTS & (0x1ul << (23)));

    ((UART_T *) (0x40880000UL))->DAT = ch;
    if(ch == '\n')
    {
        while(((UART_T *) (0x40880000UL))->FIFOSTS & (0x1ul << (23)));
        ((UART_T *) (0x40880000UL))->DAT = '\r';
    }
}
...
#line 584 "..\\..\\Library\\StdDriver\\src\\retarget.c"
    while(1)
    {
        if((((UART_T *) (0x40880000UL))->FIFOSTS & (0x1ul << (14))) == 0)
        {
            return (((UART_T *) (0x40880000UL))->DAT);
        }
    }
...
int kbhit(void)
{
    ...
    return !((((UART_T *) (0x40880000UL))->FIFOSTS & (0x1ul << (14))) == 0);
...
int IsDebugFifoEmpty(void)
{
    ...
    return ((((UART_T *) (0x40880000UL))->FIFOSTS & (0x1ul << (28))) != 0);
...
#line 709 "..\\..\\Library\\StdDriver\\src\\retarget.c"
